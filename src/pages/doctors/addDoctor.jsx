      ...
      <div className="w-full max-w-3xl bg-slate-700 p-6 rounded-lg shadow-lg space-y-6">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength="10"
            />
            {!isMobileValid && <h3 className="text-red-600">Please enter a valid mobile number.</h3>}
          </div>
          {/* Email */}
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full px-3 py-2 border border-gray-900 rounded-md"
            />
            {!isValidEmail && <h3 className="text-red-600">Please enter a valid email.</h3>}
          </div>
          {/* DOB */}
          <div>
          ...
          {/* Qualification */}
          <div>
            <label htmlFor="Qualification" className="block text-sm font-medium text-white">
              Qualification
            </label>
            <input
              type="text"
          ...
          {/* Career Start Date */}
          <div>
            <label htmlFor="CareerStartDate" className="block text-sm font-medium text-white">
              Career Start Date
            </label>
            <input
              type="date"
        ...
        {formData.Shifts.map((shift, index) => (
          <div key={index} className="mt-4 p-4 border rounded bg-gray-800">
            <h3 className="text-lg font-semibold text-white">Shift-{index + 1} Working Days</h3>
